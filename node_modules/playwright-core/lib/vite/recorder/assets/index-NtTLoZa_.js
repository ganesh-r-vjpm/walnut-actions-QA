const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/codeMirrorModule-DLQGQHyt.js","assets/codeMirrorModule-DYBRYzYX.css"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ng;function x1(){return ng||(ng=1,(function(u){function l(D,K){var ne=D.length;D.push(K);e:for(;0<ne;){var de=ne-1>>>1,Ne=D[de];if(0<c(Ne,K))D[de]=K,D[ne]=Ne,ne=de;else break e}}function a(D){return D.length===0?null:D[0]}function s(D){if(D.length===0)return null;var K=D[0],ne=D.pop();if(ne!==K){D[0]=ne;e:for(var de=0,Ne=D.length,O=Ne>>>1;de<O;){var Y=2*(de+1)-1,J=D[Y],I=Y+1,re=D[I];if(0>c(J,ne))I<Ne&&0>c(re,J)?(D[de]=re,D[I]=ne,de=I):(D[de]=J,D[Y]=ne,de=Y);else if(I<Ne&&0>c(re,ne))D[de]=re,D[I]=ne,de=I;else break e}}return K}function c(D,K){var ne=D.sortIndex-K.sortIndex;return ne!==0?ne:D.id-K.id}if(u.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var o=performance;u.unstable_now=function(){return o.now()}}else{var h=Date,m=h.now();u.unstable_now=function(){return h.now()-m}}var g=[],p=[],T=1,v=null,_=3,w=!1,x=!1,b=!1,E=!1,M=typeof setTimeout=="function"?setTimeout:null,R=typeof clearTimeout=="function"?clearTimeout:null,G=typeof setImmediate<"u"?setImmediate:null;function Q(D){for(var K=a(p);K!==null;){if(K.callback===null)s(p);else if(K.startTime<=D)s(p),K.sortIndex=K.expirationTime,l(g,K);else break;K=a(p)}}function Z(D){if(b=!1,Q(D),!x)if(a(g)!==null)x=!0,W||(W=!0,$());else{var K=a(p);K!==null&&se(Z,K.startTime-D)}}var W=!1,q=-1,V=5,U=-1;function ae(){return E?!0:!(u.unstable_now()-U<V)}function te(){if(E=!1,W){var D=u.unstable_now();U=D;var K=!0;try{e:{x=!1,b&&(b=!1,R(q),q=-1),w=!0;var ne=_;try{t:{for(Q(D),v=a(g);v!==null&&!(v.expirationTime>D&&ae());){var de=v.callback;if(typeof de=="function"){v.callback=null,_=v.priorityLevel;var Ne=de(v.expirationTime<=D);if(D=u.unstable_now(),typeof Ne=="function"){v.callback=Ne,Q(D),K=!0;break t}v===a(g)&&s(g),Q(D)}else s(g);v=a(g)}if(v!==null)K=!0;else{var O=a(p);O!==null&&se(Z,O.startTime-D),K=!1}}break e}finally{v=null,_=ne,w=!1}K=void 0}}finally{K?$():W=!1}}}var $;if(typeof G=="function")$=function(){G(te)};else if(typeof MessageChannel<"u"){var ee=new MessageChannel,we=ee.port2;ee.port1.onmessage=te,$=function(){we.postMessage(null)}}else $=function(){M(te,0)};function se(D,K){q=M(function(){D(u.unstable_now())},K)}u.unstable_IdlePriority=5,u.unstable_ImmediatePriority=1,u.unstable_LowPriority=4,u.unstable_NormalPriority=3,u.unstable_Profiling=null,u.unstable_UserBlockingPriority=2,u.unstable_cancelCallback=function(D){D.callback=null},u.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):V=0<D?Math.floor(1e3/D):5},u.unstable_getCurrentPriorityLevel=function(){return _},u.unstable_next=function(D){switch(_){case 1:case 2:case 3:var K=3;break;default:K=_}var ne=_;_=K;try{return D()}finally{_=ne}},u.unstable_requestPaint=function(){E=!0},u.unstable_runWithPriority=function(D,K){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var ne=_;_=D;try{return K()}finally{_=ne}},u.unstable_scheduleCallback=function(D,K,ne){var de=u.unstable_now();switch(typeof ne=="object"&&ne!==null?(ne=ne.delay,ne=typeof ne=="number"&&0<ne?de+ne:de):ne=de,D){case 1:var Ne=-1;break;case 2:Ne=250;break;case 5:Ne=1073741823;break;case 4:Ne=1e4;break;default:Ne=5e3}return Ne=ne+Ne,D={id:T++,callback:K,priorityLevel:D,startTime:ne,expirationTime:Ne,sortIndex:-1},ne>de?(D.sortIndex=ne,l(p,D),a(g)===null&&D===a(p)&&(b?(R(q),q=-1):b=!0,se(Z,ne-de))):(D.sortIndex=Ne,l(g,D),x||w||(x=!0,W||(W=!0,$()))),D},u.unstable_shouldYield=ae,u.unstable_wrapCallback=function(D){var K=_;return function(){var ne=_;_=K;try{return D.apply(this,arguments)}finally{_=ne}}}})(cf)),cf}var lg;function D1(){return lg||(lg=1,uf.exports=x1()),uf.exports}var rf={exports:{}},st={};/**
 * @license React
...
`&&Z!=="	"&&Z!==" ")break}let w=a.substring(_);const x=w.indexOf(`
`);x===-1?v="-":a===w||x!==w.length-1?(v="+",o&&o()):v="",w&&(a=a.slice(0,-w.length),w[w.length-1]===`
`&&(w=w.slice(0,-1)),w=w.replace(Mf,`$&${p}`));let b=!1,E,M=-1;for(E=0;E<a.length;++E){const Z=a[E];if(Z===" ")b=!0;else if(Z===`
`)M=E;else break}let R=a.substring(0,M<E?M+1:E);R&&(a=a.substring(R.length),R=R.replace(/\n+/g,`$&${p}`));let Q=(b?p?"2":"1":"")+v;if(u&&(Q+=" "+m(u.replace(/ ?[\r\n]+/g," ")),c&&c()),!T){const Z=a.replace(/\n+/g,`
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${p}`);let W=!1;const q=Mu(s,!0);h!=="folded"&&l!==ce.BLOCK_FOLDED&&(q.onOverflow=()=>{W=!0});const V=Nu(`${R}${Z}${w}`,p,_f,q);if(!W)return`>${Q}
${p}${V}`}return a=a.replace(/\n+/g,`$&${p}`),`|${Q}
${p}${R}${a}${w}`}function kv(u,l,a,s){const{type:c,value:o}=u,{actualString:h,implicitKey:m,indent:g,indentStep:p,inFlow:T}=l;if(m&&o.includes(`
...
${h}
${p}
`}};function wi(u,{flow:l,indicator:a,next:s,offset:c,onError:o,parentIndent:h,startOnNewline:m}){let g=!1,p=m,T=m,v="",_="",w=!1,x=!1,b=null,E=null,M=null,R=null,G=null,Q=null,Z=null;for(const V of u)switch(x&&(V.type!=="space"&&V.type!=="newline"&&V.type!=="comma"&&o(V.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),x=!1),b&&(p&&V.type!=="comment"&&V.type!=="newline"&&o(b,"TAB_AS_INDENT","Tabs are not allowed as indentation"),b=null),V.type){case"space":!l&&(a!=="doc-start"||(s==null?void 0:s.type)!=="flow-collection")&&V.source.includes("	")&&(b=V),T=!0;break;case"comment":{T||o(V,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const U=V.source.substring(1)||" ";v?v+=_+U:v=U,_="",p=!1;break}case"newline":p?v?v+=V.source:(!Q||a!=="seq-item-ind")&&(g=!0):_+=V.source,p=!0,w=!0,(E||M)&&(R=V),T=!0;break;case"anchor":E&&o(V,"MULTIPLE_ANCHORS","A node can have at most one anchor"),V.source.endsWith(":")&&o(V.offset+V.source.length-1,"BAD_ALIAS","Anchor ending in : is ambiguous",!0),E=V,Z??(Z=V.offset),p=!1,T=!1,x=!0;break;case"tag":{M&&o(V,"MULTIPLE_TAGS","A node can have at most one tag"),M=V,Z??(Z=V.offset),p=!1,T=!1,x=!0;break}case a:(E||M)&&o(V,"BAD_PROP_ORDER",`Anchors and tags must be after the ${V.source} indicator`),Q&&o(V,"UNEXPECTED_TOKEN",`Unexpected ${V.source} in ${l??"collection"}`),Q=V,p=a==="seq-item-ind"||a==="explicit-key-ind",T=!1;break;case"comma":if(l){G&&o(V,"UNEXPECTED_TOKEN",`Unexpected , in ${l}`),G=V,p=!1,T=!1;break}default:o(V,"UNEXPECTED_TOKEN",`Unexpected ${V.type} token`),p=!1,T=!1}const W=u[u.length-1],q=W?W.offset+W.source.length:c;return x&&s&&s.type!=="space"&&s.type!=="newline"&&s.type!=="comma"&&(s.type!=="scalar"||s.source!=="")&&o(s.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),b&&(p&&b.indent<=h||(s==null?void 0:s.type)==="block-map"||(s==null?void 0:s.type)==="block-seq")&&o(b,"TAB_AS_INDENT","Tabs are not allowed as indentation"),{comma:G,found:Q,spaceBefore:g,comment:v,hasNewline:w,anchor:E,tag:M,newlineAfterProp:R,end:q,start:Z??q}}function Da(u){if(!u)return null;switch(u.type){case"alias":case"scalar":case"double-quoted-scalar":case"single-quoted-scalar":if(u.source.includes(`
`))return!0;if(u.end){for(const l of u.end)if(l.type==="newline")return!0}return!1;case"flow-collection":for(const l of u.items){for(const a of l.start)if(a.type==="newline")return!0;if(l.sep){for(const a of l.sep)if(a.type==="newline")return!0}if(Da(l.key)||Da(l.value))return!0}return!1;default:return!0}}function Cf(u,l,a){if((l==null?void 0:l.type)==="flow-collection"){const s=l.end[0];s.indent===u&&(s.source==="]"||s.source==="}")&&Da(l)&&a(s,"BAD_INDENT","Flow end indicator should be more indented than parent",!0)}}function Up(u,l,a){const{uniqueKeys:s}=u.options;if(s===!1)return!1;const c=typeof s=="function"?s:(o,h)=>o===h||De(o)&&De(h)&&o.value===h.value;return l.some(o=>c(o.key,a))}const Eg="All mapping items must start at the same column";function ub({composeNode:u,composeEmptyNode:l},a,s,c,o){var T;const h=(o==null?void 0:o.nodeClass)??Lt,m=new h(a.schema);a.atRoot&&(a.atRoot=!1);let g=s.offset,p=null;for(const v of s.items){const{start:_,key:w,sep:x,value:b}=v,E=wi(_,{indicator:"explicit-key-ind",next:w??(x==null?void 0:x[0]),offset:g,onError:c,parentIndent:s.indent,startOnNewline:!0}),M=!E.found;if(M){if(w&&(w.type==="block-seq"?c(g,"BLOCK_AS_IMPLICIT_KEY","A block sequence may not be used as an implicit map key"):"indent"in w&&w.indent!==s.indent&&c(g,"BAD_INDENT",Eg)),!E.anchor&&!E.tag&&!x){p=E.end,E.comment&&(m.comment?m.comment+=`
`+E.comment:m.comment=E.comment);continue}(E.newlineAfterProp||Da(w))&&c(w??_[_.length-1],"MULTILINE_IMPLICIT_KEY","Implicit keys need to be on a single line")}else((T=E.found)==null?void 0:T.indent)!==s.indent&&c(g,"BAD_INDENT",Eg);a.atKey=!0;const R=E.end,G=w?u(a,w,E,c):l(a,R,_,null,E,c);a.schema.compat&&Cf(s.indent,w,c),a.atKey=!1,Up(a,m.items,G)&&c(R,"DUPLICATE_KEY","Map keys must be unique");const Q=wi(x??[],{indicator:"map-value-ind",next:b,offset:G.range[2],onError:c,parentIndent:s.indent,startOnNewline:!w||w.type==="block-scalar"});if(g=Q.end,Q.found){M&&((b==null?void 0:b.type)==="block-map"&&!Q.hasNewline&&c(g,"BLOCK_AS_IMPLICIT_KEY","Nested mappings are not allowed in compact mappings"),a.options.strict&&E.start<Q.found.offset-1024&&c(G.range,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit block mapping key"));const Z=b?u(a,b,Q,c):l(a,g,x,null,Q,c);a.schema.compat&&Cf(s.indent,b,c),g=Z.range[2];const W=new ct(G,Z);a.options.keepSourceTokens&&(W.srcToken=v),m.items.push(W)}else{M&&c(G.range,"MISSING_CHAR","Implicit map keys need to be followed by map values"),Q.comment&&(G.comment?G.comment+=`
`+Q.comment:G.comment=Q.comment);const Z=new ct(G);a.options.keepSourceTokens&&(Z.srcToken=v),m.items.push(Z)}}return p&&p<g&&c(p,"IMPOSSIBLE","Map comment with trailing content"),m.range=[s.offset,g,p??g],m}function cb({composeNode:u,composeEmptyNode:l},a,s,c,o){const h=(o==null?void 0:o.nodeClass)??el,m=new h(a.schema);a.atRoot&&(a.atRoot=!1),a.atKey&&(a.atKey=!1);let g=s.offset,p=null;for(const{start:T,value:v}of s.items){const _=wi(T,{indicator:"seq-item-ind",next:v,offset:g,onError:c,parentIndent:s.indent,startOnNewline:!0});if(!_.found)if(_.anchor||_.tag||v)(v==null?void 0:v.type)==="block-seq"?c(_.end,"BAD_INDENT","All sequence items must start at the same column"):c(g,"MISSING_CHAR","Sequence item without - indicator");else{p=_.end,_.comment&&(m.comment=_.comment);continue}const w=v?u(a,v,_,c):l(a,_.end,T,null,_,c);a.schema.compat&&Cf(s.indent,v,c),g=w.range[2],m.items.push(w)}return m.range=[s.offset,g,p??g],m}function Ba(u,l,a,s){let c="";if(u){let o=!1,h="";for(const m of u){const{source:g,type:p}=m;switch(p){case"space":o=!0;break;case"comment":{a&&!o&&s(m,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const T=g.substring(1)||" ";c?c+=h+T:c=T,h="";break}case"newline":c&&(h+=g),o=!0;break;default:s(m,"UNEXPECTED_TOKEN",`Unexpected ${p} at node end`)}l+=g.length}}return{comment:c,offset:l}}const mf="Block collections are not allowed within flow collections",gf=u=>u&&(u.type==="block-map"||u.type==="block-seq");function rb({composeNode:u,composeEmptyNode:l},a,s,c,o){var E;const h=s.start.source==="{",m=h?"flow map":"flow sequence",g=(o==null?void 0:o.nodeClass)??(h?Lt:el),p=new g(a.schema);p.flow=!0;const T=a.atRoot;T&&(a.atRoot=!1),a.atKey&&(a.atKey=!1);let v=s.offset+s.start.source.length;for(let M=0;M<s.items.length;++M){const R=s.items[M],{start:G,key:Q,sep:Z,value:W}=R,q=wi(G,{flow:m,indicator:"explicit-key-ind",next:Q??(Z==null?void 0:Z[0]),offset:v,onError:c,parentIndent:s.indent,startOnNewline:!1});if(!q.found){if(!q.anchor&&!q.tag&&!Z&&!W){M===0&&q.comma?c(q.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${m}`):M<s.items.length-1&&c(q.start,"UNEXPECTED_TOKEN",`Unexpected empty item in ${m}`),q.comment&&(p.comment?p.comment+=`
...
`+V:U.comment=V,q.comment=q.comment.substring(V.length+1)}}if(!h&&!Z&&!q.found){const V=W?u(a,W,q,c):l(a,q.end,Z,null,q,c);p.items.push(V),v=V.range[2],gf(W)&&c(V.range,"BLOCK_IN_FLOW",mf)}else{a.atKey=!0;const V=q.end,U=Q?u(a,Q,q,c):l(a,V,G,null,q,c);gf(Q)&&c(U.range,"BLOCK_IN_FLOW",mf),a.atKey=!1;const ae=wi(Z??[],{flow:m,indicator:"map-value-ind",next:W,offset:U.range[2],onError:c,parentIndent:s.indent,startOnNewline:!1});if(ae.found){if(!h&&!q.found&&a.options.strict){if(Z)for(const ee of Z){if(ee===ae.found)break;if(ee.type==="newline"){c(ee,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}q.start<ae.found.offset-1024&&c(ae.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else W&&("source"in W&&((E=W.source)==null?void 0:E[0])===":"?c(W,"MISSING_CHAR",`Missing space after : in ${m}`):c(ae.start,"MISSING_CHAR",`Missing , or : between ${m} items`));const te=W?u(a,W,ae,c):ae.found?l(a,ae.end,Z,null,ae,c):null;te?gf(W)&&c(te.range,"BLOCK_IN_FLOW",mf):ae.comment&&(U.comment?U.comment+=`
`+ae.comment:U.comment=ae.comment);const $=new ct(U,te);if(a.options.keepSourceTokens&&($.srcToken=R),h){const ee=p;Up(a,ee.items,U)&&c(V,"DUPLICATE_KEY","Map keys must be unique"),ee.items.push($)}else{const ee=new Lt(a.schema);ee.flow=!0,ee.items.push($);const we=(te??U).range;ee.range=[U.range[0],we[1],we[2]],p.items.push(ee)}v=te?te.range[2]:ae.end}}const _=h?"}":"]",[w,...x]=s.end;let b=v;if((w==null?void 0:w.source)===_)b=w.offset+w.source.length;else{const M=m[0].toUpperCase()+m.substring(1),R=T?`${M} must end with a ${_}`:`${M} in block collection must be sufficiently indented and end with a ${_}`;c(v,T?"MISSING_CHAR":"BAD_INDENT",R),w&&w.source.length!==1&&x.unshift(w)}if(x.length>0){const M=Ba(x,b,a.options.strict,c);M.comment&&(p.comment?p.comment+=`
`+M.comment:p.comment=M.comment),p.range=[s.offset,b,M.offset]}else p.range=[s.offset,b,b];return p}function pf(u,l,a,s,c,o){const h=a.type==="block-map"?ub(u,l,a,s,o):a.type==="block-seq"?cb(u,l,a,s,o):rb(u,l,a,s,o),m=h.constructor;return c==="!"||c===m.tagName?(h.tag=m.tagName,h):(c&&(h.tag=c),h)}function fb(u,l,a,s,c){var _;const o=s.tag,h=o?l.directives.tagName(o.source,w=>c(o,"TAG_RESOLVE_FAILED",w)):null;if(a.type==="block-seq"){const{anchor:w,newlineAfterProp:x}=s,b=w&&o?w.offset>o.offset?w:o:w??o;b&&(!x||x.offset<b.offset)&&c(b,"MISSING_CHAR","Missing newline after block sequence props")}const m=a.type==="block-map"?"map":a.type==="block-seq"?"seq":a.start.source==="{"?"map":"seq";if(!o||!h||h==="!"||h===Lt.tagName&&m==="map"||h===el.tagName&&m==="seq")return pf(u,l,a,c,h);let g=l.schema.tags.find(w=>w.tag===h&&w.collection===m);if(!g){const w=l.schema.knownTags[h];if((w==null?void 0:w.collection)===m)l.schema.tags.push(Object.assign({},w,{default:!1})),g=w;else return w?c(o,"BAD_COLLECTION_TYPE",`${w.tag} used for ${m} collection, but expects ${w.collection??"scalar"}`,!0):c(o,"TAG_RESOLVE_FAILED",`Unresolved tag: ${h}`,!0),pf(u,l,a,c,h)}const p=pf(u,l,a,c,h,g),T=((_=g.resolve)==null?void 0:_.call(g,p,w=>c(o,"TAG_RESOLVE_FAILED",w),l.options))??p,v=qe(T)?T:new ce(T);return v.range=p.range,v.tag=h,g!=null&&g.format&&(v.format=g.format),v}function Rp(u,l,a){const s=l.offset,c=ob(l,u.options.strict,a);if(!c)return{value:"",type:null,comment:"",range:[s,s,s]};const o=c.mode===">"?ce.BLOCK_FOLDED:ce.BLOCK_LITERAL,h=l.source?hb(l.source):[];let m=h.length;for(let b=h.length-1;b>=0;--b){const E=h[b][1];if(E===""||E==="\r")m=b;else break}if(m===0){const b=c.chomp==="+"&&h.length>0?`
`.repeat(Math.max(1,h.length-1)):"";let E=s+c.length;return l.source&&(E+=l.source.length),{value:b,type:o,comment:c.comment,range:[s,E,E]}}let g=l.indent+c.indent,p=l.offset+c.length,T=0;for(let b=0;b<m;++b){const[E,M]=h[b];if(M===""||M==="\r")c.indent===0&&E.length>g&&(g=E.length);else{E.length<g&&a(p+E.length,"MISSING_CHAR","Block scalars with more-indented leading empty lines must use an explicit indentation indicator"),c.indent===0&&(g=E.length),T=b,g===0&&!u.atRoot&&a(p,"BAD_INDENT","Block scalar values in collections must be indented");break}p+=E.length+M.length+1}for(let b=h.length-1;b>=m;--b)h[b][0].length>g&&(m=b+1);let v="",_="",w=!1;for(let b=0;b<T;++b)v+=h[b][0].slice(g)+`
`;for(let b=T;b<m;++b){let[E,M]=h[b];p+=E.length+M.length+1;const R=M[M.length-1]==="\r";if(R&&(M=M.slice(0,-1)),M&&E.length<g){const Q=`Block scalar lines must not be less indented than their ${c.indent?"explicit indentation indicator":"first line"}`;a(p-M.length-(R?2:1),"BAD_INDENT",Q),E=""}o===ce.BLOCK_LITERAL?(v+=_+E.slice(g)+M,_=`
`):E.length>g||M[0]==="	"?(_===" "?_=`
`:!w&&_===`
`&&(_=`
...
`?v+=`
`:_=`
`:(v+=_+M,_=" ",w=!1)}switch(c.chomp){case"-":break;case"+":for(let b=m;b<h.length;++b)v+=`
`+h[b][0].slice(g);v[v.length-1]!==`
`&&(v+=`
`);break;default:v+=`
`}const x=s+c.length+l.source.length;return{value:v,type:o,comment:c.comment,range:[s,x,x]}}function ob({offset:u,props:l},a,s){if(l[0].type!=="block-scalar-header")return s(l[0],"IMPOSSIBLE","Block scalar header not found"),null;const{source:c}=l[0],o=c[0];let h=0,m="",g=-1;for(let _=1;_<c.length;++_){const w=c[_];if(!m&&(w==="-"||w==="+"))m=w;else{const x=Number(w);!h&&x?h=x:g===-1&&(g=u+_)}}g!==-1&&s(g,"UNEXPECTED_TOKEN",`Block scalar header includes extra characters: ${c}`);let p=!1,T="",v=c.length;for(let _=1;_<l.length;++_){const w=l[_];switch(w.type){case"space":p=!0;case"newline":v+=w.source.length;break;case"comment":a&&!p&&s(w,"MISSING_CHAR","Comments must be separated from other tokens by white space characters"),v+=w.source.length,T=w.source.substring(1);break;case"error":s(w,"UNEXPECTED_TOKEN",w.message),v+=w.source.length;break;default:{const x=`Unexpected token in block scalar header: ${w.type}`;s(w,"UNEXPECTED_TOKEN",x);const b=w.source;b&&typeof b=="string"&&(v+=b.length)}}}return{mode:o,indent:h,chomp:m,comment:T,length:v}}function hb(u){const l=u.split(/\n( *)/),a=l[0],s=a.match(/^( *)/),o=[s!=null&&s[1]?[s[1],a.slice(s[1].length)]:["",a]];for(let h=1;h<l.length;h+=2)o.push([l[h],l[h+1]]);return o}function jp(u,l,a){const{offset:s,type:c,source:o,end:h}=u;let m,g;const p=(_,w,x)=>a(s+_,w,x);switch(c){case"scalar":m=ce.PLAIN,g=db(o,p);break;case"single-quoted-scalar":m=ce.QUOTE_SINGLE,g=mb(o,p);break;case"double-quoted-scalar":m=ce.QUOTE_DOUBLE,g=gb(o,p);break;default:return a(u,"UNEXPECTED_TOKEN",`Expected a flow scalar value, but found: ${c}`),{value:"",type:null,comment:"",range:[s,s+o.length,s+o.length]}}const T=s+o.length,v=Ba(h,T,l,a);return{value:g,type:m,comment:v.comment,range:[s,T,v.offset]}}function db(u,l){let a="";switch(u[0]){case"	":a="a tab character";break;case",":a="flow indicator character ,";break;case"%":a="directive indicator character %";break;case"|":case">":{a=`block scalar indicator ${u[0]}`;break}case"@":case"`":{a=`reserved character ${u[0]}`;break}}return a&&l(0,"BAD_SCALAR_START",`Plain value cannot start with ${a}`),Bp(u)}function mb(u,l){return(u[u.length-1]!=="'"||u.length===1)&&l(u.length,"MISSING_CHAR","Missing closing 'quote"),Bp(u.slice(1,-1)).replace(/''/g,"'")}function Bp(u){let l,a;try{l=new RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,"sy"),a=new RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
